	...
	<body>
		<form class="cd-form" method="POST" action="#">
			<legend>Enter the details</legend>
				...
				<input id="inputdefault" type='text' name='m_user' placeholder="Member username" required />
			</br>
				<input id="inputdefault" type="number" name="m_balance" placeholder="Balance to add" required />
			</br>
				<input id="inputdefault" type="submit" name="m_add" value="Add Balance" />
		</form>
	</body>
