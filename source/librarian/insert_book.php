		...
		<form class="cd-form" method="POST" action="#">
			<div class="box">
				<legend>Enter book details</legend>
					...
					<input type="number" id="inputdefault" name="b_isbn" placeholder="ISBN" required />

				</br>
					<input type="text" id="inputdefault" name="b_title" placeholder="Title" required />
				</br>
					<input type="text" id="inputdefault" name="b_author" placeholder="Author" required />
					</br>
					<h4>Category</h4>
						<p>
							<select id="inputdefault" name="b_category">
								<option>Fiction</option>
								<option>Non-fiction</option>
								<option>Education</option>
							</select>
						</p>
					<input type="number" id="inputdefault" name="b_price" placeholder="Price" required />
				</br>
					<input type="number" id="inputdefault" name="b_copies" placeholder="Copies" required />
				</br>
					<input type="submit" id="button" name="b_add" value="Add book" />
				</div>
			</form>
