	...
	<body>
		<form class="cd-form" method="POST" action="#">
			<legend>Enter your details</legend>
				...
				<input id="inputdefault" type="text" name="m_user" id="m_user" placeholder="Username" required />
				</br>
				<input id="inputdefault" type="password" name="m_pass" placeholder="Password" required />
				</br>
				<input id="inputdefault" type="text" name="m_name" placeholder="Full Name" required />
				</br>
				<input id="inputdefault" type="email" name="m_email" id="m_email" placeholder="Email" required />
				</br>
				<input id="inputdefault" type="number" name="m_balance" id="m_balance" placeholder="Initial Balance" required />
				</br>
				<input id="button" type="submit" name="m_register" value="Register" />
		</form>
	</body>
